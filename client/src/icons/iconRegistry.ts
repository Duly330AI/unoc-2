...
const ICON_REGISTRY: Record<DeviceType, DeviceIconSet> = {
  BACKBONE_GATEWAY: { simple: backboneSimple, cockpit: backboneCockpit },
  CORE_ROUTER: { simple: routerSimple, cockpit: routerCockpit },
  EDGE_ROUTER: { simple: routerSimple, cockpit: routerCockpit },
  OLT: { simple: oltSimple, cockpit: oltCockpit },
  AON_SWITCH: { simple: aonSwitchSimple, cockpit: aonSwitchCockpit },
  SPLITTER: { simple: splitterSimple, cockpit: splitterCockpit },
  ONT: { simple: ontSimple, cockpit: ontCockpit },
  BUSINESS_ONT: { simple: businessOntSimple, cockpit: businessOntCockpit },
  AON_CPE: { simple: aonCpeSimple, cockpit: aonCpeCockpit },
  SWITCH: { simple: switchSimple, cockpit: switchCockpit },
  ODF: { simple: patchPanelSimple, cockpit: patchPanelCockpit },
  NVT: { simple: amplifierSimple, cockpit: amplifierCockpit },
  HOP: { simple: amplifierSimple, cockpit: amplifierCockpit },
