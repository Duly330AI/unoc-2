...
- `deviceContainerChanged` is now emitted on successful device reparent patches and is treated as a baseline-covered event during in-flight resyncs; drag/drop UX and stronger mixed-ordering regression coverage remain open.
